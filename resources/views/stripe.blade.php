        ...
        <div class="col-md-6 col-md-offset-1">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form autocomplete="on" role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label'>Description</label> <input
                                    class='form-control' type='text' name="desc" value="{{ old('desc') }}">
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                <label class='control-label'>CVC</label> <input autocomplete='off'
                                    ...
                                    type='text' name="cvc" value="{{ old('cvc') }}">
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Month</label> <input
                                    class='form-control card-expiry-month' placeholder='MM' size='2'
                                    type='text' name="expiry-month" value="{{ old('expiry-month') }}">
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Year</label> <input
                                    class='form-control card-expiry-year' placeholder='YYYY' size='4'
                                    type='text' name="expiry-year" value="{{ old('expiry-year') }}" >
                            </div>
        ...
        <div class="col-md-4 col-md-offset-1">
           <h1>Transactions</h1> 
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>{{ date('d/m/Y H:i:s', $transaction->transaction_at)  }}</td>
                </tr>
                @endforeach
           ...
           <table class="table table-striped">
            ...
            <tr>
                ...
                <td>{{ $withdrawal->operator->name }}</td>
                <td>{{ $withdrawal->transaction_id }}</td>
                <td>{{ date('d/m/Y H:i:s', $withdrawal->transaction_at)  }}</td>
            </tr>
            @endforeach
